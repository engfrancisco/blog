...
<ol>
	...
	<li>Considerações de segurança ee xame preliminar da falha (exame visual e registro de imagem)</li>>
	<li>Exame macroscópico e registro fotográfico das superfícies de fratura, trincas e outros fenômenso superficiais detectados</li>
	<li>Seleção, identificação, preservação e limeza de fragmentos e amostras, além da comparação com componentes que não falharam</li>
			<li>Subtópico</li>
			<li>Subtópico</li>
			<li>Subtópico</li>
		</ul>
